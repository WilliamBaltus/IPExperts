          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button onClick={() => scrollToSection('services')} className="text-gray-500 hover:text-primary transition-colors font-medium text-left">Solutions</button>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-3">
                ...
                <a href="mailto:contact@ipexperts.com" className="size-10 rounded-full bg-gray-50 dark:bg-neutral-dark flex items-center justify-center text-gray-400 hover:text-primary transition-all">
